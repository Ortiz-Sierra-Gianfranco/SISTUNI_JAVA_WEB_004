...
public class CursoProfesorService {
    ...
    public CursoProfesorService() throws ClassNotFoundException {
    ...
    public boolean registrarDatos(Object grado, Object profUsuario, Object curso) throws SQLException {
        ...
        try {
            ps = cn.prepareStatement(SQL_INSERTAR_UNA_FILA);
    ...
    public boolean modificarProfesor(Object idProfCur, Object profUsuario) throws SQLException {
        PreparedStatement ps;
        try {
            ps = cn.prepareStatement(SQL_UPDATE_BY_PROFESOR);
            ps.setString(1, profUsuario.toString());
    ...
    public ArrayList<Horarios> readAll() throws SQLException {
        PreparedStatement ps;
        ResultSet rs;
    ...
    public ArrayList<Horarios> verCursos(Object codProf) throws SQLException {
        PreparedStatement ps;
        ResultSet rs;
        ArrayList<Horarios> lista = new ArrayList();
        try {
            ps = cn.prepareStatement(SQL_VER_CURSOS);
    ...
    public int GetIdCursoProf(Object grado, Object curso) throws Exception {
        ...
        ResultSet rs = null;
        try {
            ps = cn.prepareStatement(SQL_READ_BY_CURSO_GRADO);
