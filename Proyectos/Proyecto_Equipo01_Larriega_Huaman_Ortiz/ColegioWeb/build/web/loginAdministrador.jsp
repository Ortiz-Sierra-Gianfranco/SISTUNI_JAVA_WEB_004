<%-- 
    ...
    Created on : 11/08/2016, 12:26:10 PM
    Author     : USUARIO
--%>
    ...
    <body>
        ...
        <div class="contenedor">
            <table>
                <tr>
                    <td class="ancho">
                        <img class="image-login" src="img/administrador.png" />
                    </td>
                    <td>
                         <h2 class="titulo">Admnistrador</h2>
                    </td>
                </tr>
            </table>
        <hr class="border">
        
        <form method="post" action="LogonAdministradorIngreso" class="formulario">
